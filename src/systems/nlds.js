  ...
  tokens: [
    component(
      ...
      [
        ...
        htmlRegex("NLDS color token defined", "--nl-color-[a-z0-9][a-z0-9-]*\\s*:", 2),
    ...
    component(
      ...
      [
        ...
        htmlRegex("NLDS typography token defined", "--nl-typography-[a-z0-9][a-z0-9-]*\\s*:", 2),
    ...
    component(
      ...
      [
        ...
        htmlRegex("NLDS space token defined", "--nl-space-[a-z0-9][a-z0-9-]*\\s*:", 2),
